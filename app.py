...
models = {
    'diabetes': pickle.load(open(r'C:\Users\kunch\Downloads\Project2_files\Project2_files\Medical diagnosis using AI\Models\diabetes_model.sav', 'rb')),
    'heart_disease': pickle.load(open(r'C:\Users\simhadri\Downloads\Project2_files\Project2_files\Medical diagnosis using AI\Models\heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open(r'C:\Users\simhadri\Downloads\Project2_files\Project2_files\Medical diagnosis using AI\Models\parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open(r'C:\Users\simhadri\Downloads\Project2_files\Project2_files\Medical diagnosis using AI\Models\lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open(r'C:\Users\simhadri\Downloads\Project2_files\Project2_files\Medical diagnosis using AI\Models\Thyroid_model.sav', 'rb'))
}
